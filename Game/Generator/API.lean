...
def getOpenAIAPI : IO API := do
  ...
  let promptKind := (← IO.getEnv "LLMLEAN_PROMPT").getD "detailed"
  let apiKey     := "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"
  let api : API := {
    model := model,
    baseUrl := url,
    kind := APIKind.OpenAI,
